...
At first, I derive the optimal data-driven model to separate accreted stars from background stars by 
...
higher retrieval ($>90\%$) and purity ($\sim60\%$) rates than traditional selection cuts in kinematic and 
chemical space.   \\
...
Once stars are assigned to their parent progenitors, I pioneer the application of simulation-based inference 
...
producing the largest, self-consistent reconstruction to date of our Galaxy's assembly history. I predict that
...
of the Milky Way, which is estimated in total to be $2.2^{+1.1}_{-0.6} \times 10^{9}~\rm{M_{\sun}}$. 
I also provide an estimate of the growth of the
Galactic halo mass between $z\sim5$ and $z\sim1$ inferring a total mass of $5.9^{+1.4}_{-1.1} \times 10^{11}~\rm{M_{\sun}}$ 
...
into a single, fully automated, end-to-end pipeline for reconstructing the Milky Way's assembly history, and, 
